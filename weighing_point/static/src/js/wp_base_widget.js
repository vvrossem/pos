odoo.define('weighing_point.BaseWidget', function (require) {
    "use strict";
    ...
    /**
     * This is a base class for all Widgets in the Weighing Point. It mimics the one from the PoS
     * It exposes relevant data to the templates : 
    ...
    var WpBaseWidget = Widget.extend({
        init: function (parent, options) {
            this._super(parent);
            options = options || {};
            this.wp = options.wp || (parent ? parent.wp : undefined);
        ...
        format_currency: function (amount, precision) {
            var currency = (this.wp && this.wp.currency) ? this.wp.currency : {
                symbol: '$',
                position: 'after',
                rounding: 0.01,
                decimals: 2
        ...
        format_currency_no_symbol: function (amount, precision) {
            ...
            if (precision && this.wp.dp[precision] !== undefined) {
                decimals = this.wp.dp[precision];
            }
