...
var WpDB = core.Class.extend({
    name: 'openerp_wp_db', //the prefix of the localstorage data
    ...
    add_products: function(products){
        ...
        for(var i = 0, len = products.length; i < len; i++){
            ...
            var categ_id = product.wp_categ_id ? product.wp_categ_id[0] : this.root_category_id;
    ...
    is_product_in_category: function(category_ids, product_id) {
        ...
        var cat = this.get_product_by_id(product_id).wp_categ_id[0];
        while (cat) {
