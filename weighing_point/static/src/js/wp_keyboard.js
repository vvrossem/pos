odoo.define('weighing_point.keyboard', function (require) {
    "use strict";
...
/* ---------- OnScreen Keyboard Widget ---------- */
     ...
     *
     * This is copied from the point_of_sale
     *
     ...
     * It can be shown with this.show(), and is automatically shown
     * when the input_selector gets focused.
     */
    var OnscreenKeyboardWidget = Widget.extend({
        ...
        //TODO(Vincent) check deprecated initKeyboardEvent
