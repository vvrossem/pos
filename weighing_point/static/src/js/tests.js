odoo.define('weighing_point.tour.pricelist', function (require) {
    "use strict";
    ...
    function compare_backend_frontend (product, pricelist_name, quantity) {
        return function () {
            var pricelist = _.findWhere(wpmodel.pricelists, {name: pricelist_name});
            ...
            // storing the field.
            frontend_price = round_di(frontend_price, wpmodel.dp['Product Price']);
    ...
    var steps = [{
        ...
        run: function () {
            var product_wall_shelf = wpmodel.db.search_product_in_category(0, 'Wall Shelf Unit')[0];
            var product_small_shelf = wpmodel.db.search_product_in_category(0, 'Small Shelf')[0];
            var product_magnetic_board = wpmodel.db.search_product_in_category(0, 'Magnetic Board')[0];
            var product_monitor_stand = wpmodel.db.search_product_in_category(0, 'Monitor Stand')[0];
            var product_desk_pad = wpmodel.db.search_product_in_category(0, 'Desk Pad')[0];
            var product_letter_tray = wpmodel.db.search_product_in_category(0, 'Letter Tray')[0];
            var product_whiteboard = wpmodel.db.search_product_in_category(0, 'Whiteboard')[0];
            var product_miscellaneous = wpmodel.db.search_product_in_category(0, 'Miscellaneous')[0];
...
shelf have not (their price was manually overriden)",
        ...
        content: "close the weighing point frontend",
    ...
    Tour.register('wp_pricelist', { test: true, url: '/wp/web' }, steps);
});

odoo.define('weighing_point.tour.acceptance', function (require) {
    "use strict";
    ...
    Tour.register('wp_basic_order', { test: true, url: '/wp/web' }, steps);
